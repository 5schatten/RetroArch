...
enum record_config_type
{
   ...
   RECORD_CONFIG_TYPE_RECORDING_MKV_X264_LOW_QUALITY,
   RECORD_CONFIG_TYPE_RECORDING_MKV_X264_MED_QUALITY,
   RECORD_CONFIG_TYPE_RECORDING_MKV_X264_HIGH_QUALITY,
   RECORD_CONFIG_TYPE_RECORDING_MKV_X264_LOSSLESS_QUALITY,
   RECORD_CONFIG_TYPE_RECORDING_WEBM_VP8_FAST,
   RECORD_CONFIG_TYPE_RECORDING_WEBM_VP8_HIGH_QUALITY,
   RECORD_CONFIG_TYPE_RECORDING_WEBM_VP9_FAST,
   RECORD_CONFIG_TYPE_RECORDING_WEBM_VP9_HIGH_QUALITY,
   RECORD_CONFIG_TYPE_RECORDING_WEBM_GIF,
   RECORD_CONFIG_TYPE_STREAMING_CUSTOM,
   RECORD_CONFIG_TYPE_STREAMING_X264_LOW_QUALITY,
   RECORD_CONFIG_TYPE_STREAMING_X264_MED_QUALITY,
   RECORD_CONFIG_TYPE_STREAMING_X264_HIGH_QUALITY,
   RECORD_CONFIG_TYPE_STREAMING_X264_NETPLAY
